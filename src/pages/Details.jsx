    ...
    <m.div
      ...
      <div className='z-10 flex flex-col items-center justify-center w-full min-h-screen'>
        <div className='text-white text-center'>
          <h3 className='text-2xl font-serif drop-shadow-[0_2.2px_2.2px_rgba(0,0,0,0.8)]'>
        ...
        <h1 className='text-9xl select-none abril-fatface-regular text-white drop-shadow-[0_2.2px_2.2px_rgba(0,0,0,0.8)]'>
          Innovatia 3.0
        </h1>
      </div>
